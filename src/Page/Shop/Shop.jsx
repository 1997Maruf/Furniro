    ...
    <div className="">
        ...
        <div className=" ">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid lg:ml-0 ml-11 lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-[30px] mt-[40px]">
              <div className="w-[285px] group cursor-pointer relative">
                ...
                <div className="opacity-0 lg:w-[285px] h-[446px] -mt-[300px] flex flex-col justify-center items-center  absolute group-hover:bg-[#544f4f83] group-hover:opacity-100 transition-opacity duration-300">
                  <Link
                    to="/details"
                    className="w-[202px] cursor-pointer h-[48px] border-[1px] border-[#333] bg-white px-[52px] py-[12px] text-[16px] text-[#B88E2F] leading-[24px]"
                  >
                    Add to cart
                  </Link>
                ...
                <div className="px-[16px] w-[285px] pt-[16px] pb-[30px] bg-[#F4F5F7]">
                  ...
                  <p className="flex gap-[16px] text-[20px] text-[#3A3A3A] font-medium">
                    Rp 2.500.000{" "}
                    <span className="text-[#B0B0B0] font-normal">
                      Rp 3.500.000
                    </span>
                  </p>
                </div>
            ...
            <div className="flex items-center justify-center gap-[38px] mt-[40px]">
              <p className="w-[60px] h-[60px] bg-[#B88E2F] rounded-[10px] text-white px-[27px] py-[15px]">
                1
              </p>
              <p className="w-[60px] h-[60px] bg-[#f9f1e7] rounded-[10px] text-black px-[27px] py-[15px]">
                2
              </p>
              <p className="w-[60px] h-[60px] bg-[#f9f1e7] rounded-[10px] text-black px-[27px] py-[15px]">
                3
              </p>
              <p className="w-[98px] h-[60px] bg-[#f9f1e7] rounded-[10px] text-black px-[27px] py-[15px]">
                Next
              </p>
            </div>
          </div>
      ...
      <div className="flex items-center mt-[85px] gap-[50px] bg-[#faf3ea] py-[100px] justify-center">
        <div className="flex gap-[10px]">
          ...
          <div className="">
            <h2 className="text-[25px] text-[#000] font-semibold leading-[37px]">
              High Quality
            </h2>
            <p className="mt-[2px] text-[20px] text-[#898989] font-medium leading-[30px]">
