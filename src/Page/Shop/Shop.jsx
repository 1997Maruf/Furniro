import img from "../../assets/imag/shop-img.png";
import img1 from "../../assets/imag/image 99.png";
import img2 from "../../assets/imag/image 100.png";
import img3 from "../../assets/imag/image 101.png";
import img4 from "../../assets/imag/image 1.png"
import img5 from "../../assets/imag/image 3.png"
import img6 from "../../assets/imag/image 4.png"
import img7 from "../../assets/imag/image 7.png"
import img8 from "../../assets/imag/image 8.png"
      ...
      <div className="container mx-auto ">
        ...
        >
          <div className="flex  justify-center">
            <h2 className="text-[48px] text-[#000] mt-[121px] font-semibold">
              Shop
            </h2>
          </div>
          <p className="flex items-center justify-center text-[16px] text-[#000]">
            Home
            <svg
        ...
        <div className="flex px-[50px] bg-[#F9F1E7] gap-[200px] py-[23px]">
          <div className="flex items-center  gap-[24px]">
            <div className="flex gap-[12px] ml-[23px]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
                height="25"
              ...
              <p className="text-[20px] text-[#000]">Filter</p>
            </div>
            <div className="flex items-center gap-[24px]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex gap-[29px]">
            <div className="flex items-center gap-[17px]">
              <p className="text-[20px] text-[#000]">Show</p>
              <p className="w-[55px] flex justify-center bg-[#fff] h-[55px] text-[#9F9F9F] items-center text-[20px]">
                16
              </p>
            </div>
            <div className="flex items-center gap-[17px]">
              <p className="text-[20px] w-[100px] text-[#000]">Short by</p>
              <p className="w-[188px] flex justify-center bg-[#fff] h-[55px] text-[#9F9F9F] items-center text-[20px]">
                16
              </p>
            </div>
          </div>
        </div>
        <div className="grid lg:ml-0 ml-11 lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-[30px] mt-[40px]">
          <div className="w-[285px] group cursor-pointer relative">
            <img src={img8} alt="" className="relative img" />
            <div className="opacity-0 lg:w-[285px] h-[446px] -mt-[300px] flex flex-col justify-center items-center  absolute group-hover:bg-[#544f4f83] group-hover:opacity-100 transition-opacity duration-300">
              <Link to="/details" className="w-[202px] cursor-pointer h-[48px] border-[1px] border-[#333] bg-white px-[52px] py-[12px] text-[16px] text-[#B88E2F] leading-[24px]">
                Add to cart
              </Link>
              <div className="flex text-white gap-[20px] items-center mt-[24px] img-hover:opacity-">
            ...
            <p className="w-[48px] h-[48px] flex justify-center items-center text-white -mt-[259px] ml-[218px] bg-[#E97171] tex-[16px] font-medium leading-[24px] rounded-full absolute">
              -30%
            </p>
            <div className="px-[16px] w-[285px] pt-[16px] pb-[30px] bg-[#F4F5F7]">
              <a href="#">
                <h2 className="text-[24px] cursor-pointer text-[#333] font-semibold">
                  Syltherine
                </h2>
              </a>
              <p className="mt-[8px] text-[16px] text-[#898989] font-medium leading-[24px]">
                Stylish cafe chair
              </p>
              <p className="flex gap-[16px] text-[20px] text-[#3A3A3A] font-medium">
                Rp 2.500.000{" "}
                <span className="text-[#B0B0B0] font-normal">Rp 3.500.000</span>
              </p>
            </div>
          </div>
          ...
          <div className="w-[285px] group cursor-pointer relative">
            <img src={img4} alt="" className="relative img" />
            <div className="opacity-0 lg:w-[285px] h-[446px] -mt-[300px] flex flex-col justify-center items-center  absolute group-hover:bg-[#544f4f83] group-hover:opacity-100 transition-opacity duration-300">
              <Link to="/details" className="w-[202px] cursor-pointer h-[48px] border-[1px] border-[#333] bg-white px-[52px] py-[12px] text-[16px] text-[#B88E2F] leading-[24px]">
                Add to cart
              </Link>
            ...
            <p className="w-[48px] h-[48px] flex justify-center items-center text-white -mt-[259px] ml-[218px] bg-[#2ec1ac] tex-[16px] font-medium leading-[24px] rounded-full absolute">
              New
            </p>
            <div className="px-[16px] w-[285px] pt-[16px] pb-[30px] bg-[#F4F5F7]">
              <a href="#">
          ...
          <div className="w-[285px] group cursor-pointer relative">
            <img src={img5} alt="" className="relative img" />
            <div className="opacity-0 lg:w-[285px] h-[446px] -mt-[300px] flex flex-col justify-center items-center  absolute group-hover:bg-[#544f4f83] group-hover:opacity-100 transition-opacity duration-300">
              <Link to="/details" className="w-[202px] cursor-pointer h-[48px] border-[1px] border-[#333] bg-white px-[52px] py-[12px] text-[16px] text-[#B88E2F] leading-[24px]">
                Add to cart
              </Link>
          ...
          <div className="w-[285px] group cursor-pointer relative">
            <img src={img6} alt="" className="relative img" />
            <div className="opacity-0 lg:w-[285px] h-[446px] -mt-[300px] flex flex-col justify-center items-center  absolute group-hover:bg-[#544f4f83] group-hover:opacity-100 transition-opacity duration-300">
              <Link to="/details" className="w-[202px] cursor-pointer h-[48px] border-[1px] border-[#333] bg-white px-[52px] py-[12px] text-[16px] text-[#B88E2F] leading-[24px]">
                Add to cart
              </Link>
          ...
          <div className="w-[285px] group cursor-pointer relative">
            <img src={img7} alt="" className="relative img" />
            <div className="opacity-0 lg:w-[285px] h-[446px] -mt-[300px] flex flex-col justify-center items-center  absolute group-hover:bg-[#544f4f83] group-hover:opacity-100 transition-opacity duration-300">
              <button className="w-[202px] cursor-pointer h-[48px] border-[1px] border-[#333] bg-white px-[52px] py-[12px] text-[16px] text-[#B88E2F] leading-[24px]">
                Add to cart
              </button>
              <div className="flex text-white gap-[20px] items-center mt-[24px] img-hover:opacity-">
                <p className="flex gap-[4px] items-center">
        ...
        <div className="flex items-center justify-center gap-[38px] mt-[40px]">
            <p className="w-[60px] h-[60px] bg-[#B88E2F] rounded-[10px] text-white px-[27px] py-[15px]">1</p>
            <p className="w-[60px] h-[60px] bg-[#f9f1e7] rounded-[10px] text-black px-[27px] py-[15px]">2</p>
            <p className="w-[60px] h-[60px] bg-[#f9f1e7] rounded-[10px] text-black px-[27px] py-[15px]">3</p>
            <p className="w-[98px] h-[60px] bg-[#f9f1e7] rounded-[10px] text-black px-[27px] py-[15px]">Next</p>
        </div>
       
      </div>
       <div className="flex items-center mt-[85px] gap-[50px] bg-[#faf3ea] py-[100px] justify-center">
            <div className="flex gap-[10px]">
                ...
                <div className="">
                    <h2 className="text-[25px] text-[#000] font-semibold leading-[37px]">High Quality</h2>
                    <p className="mt-[2px] text-[20px] text-[#898989] font-medium leading-[30px]">crafted from top materials</p>
                </div>
            </div>
            <div className="flex gap-[10px]">
                ...
                <div className="">
                    <h2 className="text-[25px] text-[#000] font-semibold leading-[37px]">Warranty Protection</h2>
                    <p className="mt-[2px] text-[20px] text-[#898989] font-medium leading-[30px]">Over 2 years</p>
                </div>
            </div>
            <div className="flex gap-[10px]">
                <svg xmlns="http://www.w3.org/2000/svg" width="61" height="60" viewBox="0 0 61 60" fill="none">
                ...
                <div className="">
                    <h2 className="text-[25px] text-[#000] font-semibold leading-[37px]">Free Shipping</h2>
                    <p className="mt-[2px] text-[20px] text-[#898989] font-medium leading-[30px]">Order over 150 $</p>
                </div>
            </div>
            <div className="flex gap-[10px]">
                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none">
                ...
                <div className="">
                    <h2 className="text-[25px] text-[#000] font-semibold leading-[37px]">24 / 7 Support</h2>
                    <p className="mt-[2px] text-[20px] text-[#898989] font-medium leading-[30px]">Dedicated support</p>
                </div>
            </div>
        </div>
    </div>
