        ...
        <div>
            <div className="container lg:w-[1440px] mx-auto">
               <div className="flex items-center bg-[#f9f1e7] py-[31px] gap-[34px] h-[100px] px-4 lg:px-[100px]">
                ...
                <Link to="/" className="text-[#9F9F9F] text-[16px]">Home</Link>
                 <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                 <path d="M6 15L11 10L6 5L7 3L14 10L7 17L6 15Z" fill="black"/>
                 </svg>
                  <Link to="/shop" className="text-[#9F9F9F] text-[16px]">Shop</Link>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                 <path d="M6 15L11 10L6 5L7 3L14 10L7 17L6 15Z" fill="black"/>
                 </svg>
               ...
               <div className="lg:flex lg:px-[95px] gap-[106px]  pb-[67px] mt-[42px]">
                ...
                <div className="lg:px-0 px-3">
                    ...
                    <p className="text-[20px] text-[#9F9F9F] font-medium">Rs. 250,000.00</p>
                    ...
                    <p className="text-[#000] mt-[18px]">Setting the bar as one of the loudest speakers in its class, the Kilburn is a compact, stout-hearted hero with a well-balanced audio which boasts a clear midrange and extended highs for a sound.</p>
                     <p className="mt-[22px] text-[#9F9F9F]">Size</p>
                     <div className="flex gap-[16px]  items-center mt-[12px]">
                        <p className="w-[30px] h-[30px] bg-[#B88E2F] cursor-pointer rounded-[5px] text-white flex items-center justify-center">L</p>
                        <p className="w-[30px] h-[30px] bg-[#f9f1e7] cursor-pointer rounded-[5px] text-black flex items-center justify-center">XL</p>
                        <p className="w-[30px] h-[30px] bg-[#f9f1e7] cursor-pointer rounded-[5px] text-black flex items-center justify-center">XS</p>
                     </div>
                     ...
                     <div className="flex lg-flex-row flex-col justify-center mt-[32px] gap-[18px]">
                        <div className="w-[123px] h-[64px] border-[1px] rounded-[10px] flex gap-[35px] items-center justify-center"><span>-</span> 1 <span>+</span> </div>
                        <div className="">
                            <button className="w-[215px] h-[64px] border-[1px] rounded-[10px] flex  items-center justify-center text-[20px] text-[#000]">Add To Cart</button>
                        </div>
                        <div className="">
                              <button className="w-[215px] h-[64px] border-[1px] rounded-[10px] flex  items-center justify-center text-[20px] text-[#000]">+ Compare</button>
                        </div>
                     </div>
                     <div className="divider"></div>
                     <div className="">
                        <p className="text-[#9F9F9F]">SKU<span className="ml-[61px]">: SS001</span></p>
                        <p className="text-[#9F9F9F] mt-[12px]">Category<span className="ml-[28px]">: Sofas</span></p>
                        <p className="text-[#9F9F9F] mt-[12px]">Tags<span className="ml-[60px]">: Sofa, Chair, Home, Shop</span></p>
                        <p className="text-[#9F9F9F] mt-[12px] flex items-center">Share<span className="ml-[50px] flex  gap-[25px] ">
                            : <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
               ...
               <div className="">
                  ...
                  <TabPanel>
                  <div className="">
                    <p className=" text-[#9F9F9F] text-[16px] lg:px-[207px] px-7">Embodying the raw, wayward spirit of rock ‘n’ roll, the Kilburn portable active stereo speaker takes the unmistakable look and sound of Marshall, unplugs the chords, and takes the show on the road.</p>
                    <p className="mt-[30px] text-[#9F9F9F] text-[16px] lg:px-[207px] px-7">Weighing in under 7 pounds, the Kilburn is a lightweight piece of vintage styled engineering. Setting the bar as one of the loudest speakers in its class, the Kilburn is a compact, stout-hearted hero with a well-balanced audio which boasts a clear midrange and extended highs for a sound that is both articulate and pronounced. The analogue knobs allow you to fine tune the controls to your personal preferences while the guitar-influenced leather strap enables easy and stylish travel.</p>
                  ...
                  <TabPanel>
                  <div className="">
                    <p className=" text-[#9F9F9F] text-[16px] px-[207px]">Embodying the raw, wayward spirit of rock ‘n’ roll, the Kilburn portable active stereo speaker takes the unmistakable look and sound of Marshall, unplugs the chords, and takes the show on the road.</p>
                    <p className="mt-[30px] text-[#9F9F9F] text-[16px] px-[207px]">Weighing in under 7 pounds, the Kilburn is a lightweight piece of vintage styled engineering. Setting the bar as one of the loudest speakers in its class, the Kilburn is a compact, stout-hearted hero with a well-balanced audio which boasts a clear midrange and extended highs for a sound that is both articulate and pronounced. The analogue knobs allow you to fine tune the controls to your personal preferences while the guitar-influenced leather strap enables easy and stylish travel.</p>
